		...
		methods: {
			...
			qrR(path) {
				...
				uni.getImageInfo({
					...
					success(res) {
						// canvas绘制海报
						ctx.drawImage(that.cover, 0, 0, uni.upx2px(632), uni.upx2px(687)); //绘制白色的背景图片
						...
						ctx.drawImage(path, uni.upx2px(140), uni.upx2px(80), uni.upx2px(350), uni.upx2px(350)); //绘制二维码
						//绘制'邀请码'
						ctx.setFontSize(20);
